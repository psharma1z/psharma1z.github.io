    ...
    const data =  d3.csv('data/who_suicide_statistics.csv').then(function(data) {
     ...
     data = d3.nest()
      ...
      .text(function (d) { return d.key; });
        ...
        filterDataCountry = data;//(data.filter(function(d){return d.key==filterValueOfCountry|| d.key=="United States Of America"}))
        console.log(filterDataCountry)
            // The number of datapoints
            var n = filterDataCountry.length;
    ...
    const data =  d3.csv('data/who_suicide_statistics.csv').then(function(data) {
     ...
     data = d3.nest()
      ...
      .text(function (d) { return d.key; });
        ...
        filterDataCountry = (data.filter(function(d){return d.key==filterValueOfCountry|| d.key=="United States Of America"}))
        console.log(filterDataCountry)
